(function(){
    ...
    var goodsController = function($scope, $filter, infoboxService, goodsFactory, errorService, $timeout){
        $scope.measure_unit = {};
        $scope.goods_type = {};
        $scope.goods_class = {};
        $scope.goodsdata = {};
    ...
    goodsController.$inject = ['$scope', '$filter', 'infoboxService', 'goodsFactory', 'errorService', '$timeout'];
